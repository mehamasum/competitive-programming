...
int main() {
  ...
  printSet(40); S=turnOffLastBit(40); printSet(S);
  printf("S = %d, turn off last bit in S, S = %d\n", 40, S=turnOffLastBit(40));

  printSet(41); S=turnOnLastZero(41); printSet(S);
  printf("S = %d, turn on last zero in S, S = %d\n", 41, turnOnLastZero(41));

  printSet(39); S=turnOffLastConsecutiveBits(39); printSet(S);
  printf("S = %d, turn off last consectuve bits in S, S = %d\n", 39, turnOffLastConsecutiveBits(39));

  printSet(36); S=turnOnLastConsecutiveZeroes(36); printSet(S);
